(async () => {
    ...
    var arguments2, Leveling, command, object_formanswer, giftcards, Total_XP_of_member, giftcardlist, member_unix, Object_USER_ID, LOG, current_level_of_message_author, How_much_XP_has_message_author, author, Object_Economy, volume, economy, onoff, channel, cooldown, list_economy, giftcard, random_numb;
